...
public class GetHyperTrackUserActivity extends BaseActivity {
    ...
    private com.hypertrack.uberx_consumer.models.User mUser = null;
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot != null && dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                        ...
                        for(DataSnapshot childDataSnapshot : dataSnapshot.getChildren()) {
                            ...
                            mUser = childDataSnapshot.getValue(com.hypertrack.uberx_consumer.models.User.class);
                        }
    ...
    private void updateFirebase(User hyperTrackUser) {
        ...
        com.hypertrack.uberx_consumer.models.User user = new com.hypertrack.uberx_consumer.models.User();
